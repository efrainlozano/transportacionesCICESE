...
public class LoginActivity extends AppCompatActivity {
    ...
    private class validarLogin extends AsyncTask<String, Void, ArrayList> {
        // Do some validation here
        protected ArrayList doInBackground(String... urls) {
            fG= new funcionesGeneradoras(getApplicationContext());//Instanciamos la clase que hace la conexion a la API
            return fG.functionGetRequest("glogin", fields, values);//Enviamos parametros de consulta
        }
