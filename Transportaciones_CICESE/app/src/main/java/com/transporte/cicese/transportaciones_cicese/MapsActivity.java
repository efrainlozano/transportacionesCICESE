...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   /* @Override
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(Double.valueOf(i.get("latitud").toString()), Double.valueOf(i.get("longitud").toString()));
        mMap.addMarker(new MarkerOptions().position(location).title("CICESE TRANSPORTES"));
